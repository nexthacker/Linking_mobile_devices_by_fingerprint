...
static void showMetadata(SnifferPacket *snifferPacket) {
  ...
  Serial.print("RSSI: ");
  //int rssi_unconverted = snifferPacket->rx_ctrl.rssi;
  //char rssi;
  //sprintf(rssi, "%d", *rssi_unconverted);
  //Serial.print(rssi);
  ...
  //strcat(message,wifi_get_channel());
  //strcat(message,separator); 
  //strcat(message,addr);
  //strcat(message,separator);
  //strcat(message,Sequence);
  //strcat(message,separator);
  //strcpy(message,ssid);
...
void deleteFile(void) {
  ...
  if(SPIFFS.remove("/log.txt")){
    Serial.println("Erro o remover arquivo!");
  }
}
